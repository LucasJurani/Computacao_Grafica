...
void Display(void) {
    ...
    float camPosition_array[3] = {-0.1f, -0.4f, 0.1f};
    float upCam_array[3] = {0.0f, 1.0f, 0.0f};
    float topointCam_array[3] = {0.0f, 0.0f, -1.0f};

    glm::vec3 camPosition = glm::make_vec3(camPosition_array); //Cam position
    glm::vec3 upCam = glm::make_vec3(upCam_array);	//Up vector
    glm::vec3 topointCam = glm::make_vec3(topointCam_array);

    glm::vec3 Zc = glm::make_vec3(glm::normalize(camPosition - topointCam));
